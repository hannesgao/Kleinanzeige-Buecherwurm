...
class NotificationManager:
    ...
    def _create_listing_html(self, listings: List[Dict]) -> str:
        ...
        <body>
            <h1>Neue Bücher auf Kleinanzeigen 📚</h1>
            <p>Es wurden <strong>{count}</strong> neue kostenlose Bücher-Sammlungen gefunden!</p>
        ...
        for listing in listings:
            ...
            price_text = 'Zu verschenken' if price == 0 else f'{price:.2f} €'
            ...
            <div class="listing clearfix">
                ...
                <a href="{url}" class="view-button">Anzeige ansehen →</a>
            </div>
            """
        
        html += """
            <div class="footer">
                <p>Diese E-Mail wurde automatisch vom Kleinanzeigen-Bücherwurm generiert.</p>
                <p>Um keine weiteren Benachrichtigungen zu erhalten, passen Sie bitte Ihre Konfiguration an.</p>
            </div>
        </body>
        </html>
        """
